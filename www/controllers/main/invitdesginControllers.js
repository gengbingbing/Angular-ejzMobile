define(['app','mainService','utilsService'],function (app){
	...
	app.register.controller('invitdesginCtrl', ['$scope','mainAjax','utils','$templateCache',function($scope,mainAjax,utils,$templateCache){
		...
		$scope.invitdesgin=[
			...
			{hrefimg:'#/main/desgincenter',img:'images/photo_img.png',name:'吴克群',type:"高级",time:"3",hreficon:'#/main/sizehome',address:"陕西西安"},
